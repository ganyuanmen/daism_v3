...
export default withSession(async (req, res) => {
    ...
    try {
        ...
        if (id[0] == '0') { //增加
            ...
            let rear={title:title[0],content:content[0],is_send:isSend[0],is_discussion:isDiscussion[0],top_img:path};
            if(daoid) rear={...rear,
                start_time:startTime?startTime[0]:null,
                end_time:endTime?endTime[0]:null,
                event_url:eventUrl?eventUrl[0]:null,
                event_address:eventAddress?eventAddress[0]:null,
                time_event:time_event?time_event[0]:null}
